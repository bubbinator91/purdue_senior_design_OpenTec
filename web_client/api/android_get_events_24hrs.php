<?php
	...
	$query1 = "SELECT * FROM opentec.events WHERE timestamp >= CURDATE() - INTERVAL 24 HOUR";
	$query2 = "SELECT DATE_SUB(timestamp, INTERVAL 1 HOUR) AS 'before' FROM opentec.events WHERE timestamp >= CURDATE() - INTERVAL 24 HOUR";
	$query3 = "SELECT DATE_ADD(timestamp, INTERVAL 1 HOUR) AS 'after' FROM opentec.events WHERE timestamp >= CURDATE() - INTERVAL 24 HOUR";
